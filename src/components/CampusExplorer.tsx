      ...
      <div className="w-full lg:w-1/3 h-[600px] flex flex-col bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div className="p-4 border-b border-gray-200 bg-white">
          <input 
            ...
            className="w-full px-4 py-2 bg-brand-light border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
          />
        </div>

        {/* Switcher Tab */}
        <div className="flex border-b border-gray-200 bg-brand-light">
          <button 
            ...
            <div>
              ...
              {Object.entries(edificiRaggruppati).map(([categoria, lista]) => (
                <div key={categoria} className="mb-6">
                  <h3 className="text-sm font-extrabold font-montserrat text-brand-dark mb-3 border-b border-gray-100 pb-2">
                    ...
                    {lista.map(edificio => (
                      <li key={edificio.id}>
                        <button
                          ...
                          className="w-full text-left p-3 rounded-lg bg-brand-light border border-gray-100 hover:border-blue-300 hover:bg-blue-50 transition-all flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                        >
            ...
            <div>
              ...
              {auleRaggruppatePerPiano.map(gruppo => (
                <div key={gruppo.piano} className="mb-6">
                   <h3 className="text-sm font-extrabold font-montserrat text-brand-dark mb-3 border-b border-gray-100 pb-2 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {gruppo.aule.map(aula => (
                      <button
                        ...
                        className="text-left p-2 rounded-lg bg-brand-light border border-gray-100 hover:border-blue-300 hover:bg-blue-50 transition-all disabled:opacity-50 group"
                      >
